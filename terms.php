...
<div class="pt-32 pb-24 bg-white">
    <div class="container mx-auto px-6 max-w-4xl">
        ...
        <div class="prose prose-slate max-w-none text-slate-600 space-y-6">
            ...
            <p>While our technicians take the utmost care during installations, Stream Activate Hub is not liable for pre-existing structural damage to your home or hardware failure of the devices being installed.</p>
            <h2 class="text-2xl font-bold text-slate-900 mt-8 mb-4">Contact</h2>
            <p>For questions regarding these Terms, contact us at support@streamactivatehub.com.</p>
        </div>
    </div>
</div>
